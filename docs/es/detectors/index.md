...
| [Ciclos de Paquetes](/es/detectors/package-cycle)   | `package_cycle`      | Dependencias cíclicas entre paquetes               | ✅          |
...
| [Módulo Disperso](/es/detectors/scattered-module)      | `scattered_module` | Funcionalidad dispersa en demasiados archivos      | ✅          |
...
| [Abuso de Barrel](/es/detectors/barrel-abuse)                | `barrel_file_abuse`   | Archivos barrel grandes que causan acoplamiento         | ✅          |
...
| [Estado Mutable Compartido](/es/detectors/shared-mutable-state)       | `shared_mutable_state` | Variables mutables exportadas                 | ✅          |

## Métricas Arquitectónicas

| Detector                                                 | ID                       | Descripción                               | Por defecto |
| -------------------------------------------------------- | ------------------------ | ----------------------------------------- | ----------- |
| [Violación de Abstractez](/es/detectors/abstractness)    | `abstractness_violation` | Zonas de Dolor/Inutilidad (métrica I+A)   | ✅          |
