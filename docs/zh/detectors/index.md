...
| [包循环](/zh/detectors/package-cycle)        | `package_cycle`      | 包之间的循环依赖       | ✅   |
...
| [分散模块](/zh/detectors/scattered-module) | `scattered_module` | 功能分散在过多的文件中           | ✅   |
...
| [Barrel 滥用](/zh/detectors/barrel-abuse)         | `barrel_file_abuse`   | 导致耦合的大型 Barrel 文件       | ✅   |
...
| [共享可变状态](/zh/detectors/shared-mutable-state) | `shared_mutable_state` | 导出的可变变量         | ✅   |

## 架构指标

| 检测器                                     | ID                       | 描述                   | 默认 |
| ------------------------------------------ | ------------------------ | ---------------------- | ---- |
| [抽象性违规](/zh/detectors/abstractness)   | `abstractness_violation` | 痛苦/无用区 (I+A 指标) | ✅   |
