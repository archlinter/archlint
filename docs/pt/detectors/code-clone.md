...
Este detector identifica blocos de código duplicados em seu projeto. Suporta clones de **Tipo-1** (cópias exatas) e **Tipo-2** (variáveis/identificadores renomeados).
