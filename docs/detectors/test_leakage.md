...
- **Broken builds**: Many build tools exclude `*.test.ts` files during production compilation. If your production code depends on them, your app will simply fail to build or crash at runtime.
