---
title: 検出器の概要
description: "archlintの28以上のアーキテクチャ・スメル検出器を探索します。循環依存、レイヤー違反、ゴッドモジュールなどを含みます。"
---
...
| 検出器                                              | ID                      | 説明                             | デフォルト |
| --------------------------------------------------- | ----------------------- | -------------------------------- | ---------- |
| [循環的複雑度](/ja/detectors/cyclomatic_complexity) | `cyclomatic_complexity` | 循環的複雑度が高い関数           | ✅         |
| [認知的複雑度](/ja/detectors/cognitive_complexity)  | `cognitive_complexity`  | 認知的複雑度が高い関数           | ✅         |
