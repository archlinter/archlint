...
description: "Узнайте, как archlint понимает архитектурные паттерны популярных фреймворков, таких как NestJS, Next.js, React, и адаптирует анализ соответственно."
---
