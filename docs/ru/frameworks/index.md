...
archlint автоматически определяет, какие фреймворки используются в вашем проекте, просматривая `package.json` и структуру файлов. Вы также можете явно установить или переопределить это в `.archlint.yaml`:
