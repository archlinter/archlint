---
title: Поддержка NestJS
description: "Специализированный анализ для модульной архитектуры NestJS, распознавание декораторов @Module, Controllers, Providers и обеспечение соблюдения слоев."
---
