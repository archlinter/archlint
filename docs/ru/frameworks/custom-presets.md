---
title: Пресеты фреймворков
description: "Узнайте, как создавать пользовательские пресеты на базе YAML для понимания специфичных для фреймворков паттернов и уменьшения ложных срабатываний в анализе archlint."
---
