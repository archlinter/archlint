---
title: Поддержка oclif
description: "Встроенная поддержка для фреймворка CLI oclif, распознавание файлов команд как точек входа и предоставление архитектурных пресетов."
---
