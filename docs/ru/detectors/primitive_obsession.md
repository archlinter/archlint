...
description: "Обнаруживает чрезмерное использование примитивных типов для представления концепций предметной области, которые должны быть инкапсулированы в конкретных типах или классах."
---
