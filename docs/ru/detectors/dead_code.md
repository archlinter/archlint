---
title: Мертвый код
description: "Обнаруживает экспортируемые функции, классы или переменные, которые не используются нигде в проекте, чтобы снизить нагрузку на поддержку и уменьшить путаницу."
---
