---
title: Злоупотребление Barrel-файлами
description: "Barrel-файлы (index.ts) могут вызывать косвенные циклические зависимости и проблемы с производительностью, если они разрастаются слишком сильно."
---
