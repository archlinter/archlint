---
title: Нарушение слоев
description: "Обнаруживает, когда код в одном архитектурном слое неправильно импортирует код из другого слоя, нарушая абстракции и принцип единственной ответственности."
---
