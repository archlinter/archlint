---
title: Импорты с побочными эффектами
description: "Определяет импорты, выполняемые только ради их побочных эффектов, которые изменяют глобальное состояние, делая зависимости менее явными, а поведение недетерминированным."
---
