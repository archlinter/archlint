---
title: Зависть к чужим функциям
description: "Обнаруживает методы, которые больше интересуются данными другого класса, чем своими собственными, что указывает на нарушение инкапсуляции."
---
