---
title: Неустойчивый интерфейс
description: "Определяет модули, чей публичный API часто меняется, в то время как от них зависят многие модули, вызывая эффект ряби по всей кодовой базе."
---
