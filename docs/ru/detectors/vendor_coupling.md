---
title: Связанность с вендором
description: "Обнаруживает модули, слишком тесно связанные с конкретными внешними библиотеками, что затрудняет будущие миграции и тестирование."
---
