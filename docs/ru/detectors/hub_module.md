---
title: Модуль-концентратор
description: "Определяет центральные модули с высоким fan-in и fan-out, которые действуют как опасные единые точки отказа в вашей архитектуре."
---
