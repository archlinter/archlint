...
«Модуль-концентратор» — это как оживленный перекресток, на котором забыли поставить светофоры. Это файл, от которого все зависят, и который сам зависит от всех подряд, но при этом в нем почти нет собственной логики.
