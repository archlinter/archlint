---
title: Рассредоточенный модуль
description: "Определяет модули, где внутренние элементы плохо связаны друг с другом, что указывает на отсутствие единой цели и нарушение принципа \"вещи, которые меняются вместе, должны оставаться вместе\"."
---
