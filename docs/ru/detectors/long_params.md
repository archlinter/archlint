---
title: Длинный список параметров
description: "Обнаруживает функции с слишком большим количеством параметров, которые трудно использовать и читать, что указывает на функции, которые делают слишком много."
---
