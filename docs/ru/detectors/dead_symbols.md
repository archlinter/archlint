---
title: Мертвые символы
description: "Находит функции, переменные или классы, которые определены, но никогда не используются локально, уменьшая беспорядок в коде и улучшая поддерживаемость."
---
