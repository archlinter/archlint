---
title: Большой файл
description: "Определяет исходные файлы, которые превышают определенное количество строк, что указывает на нарушение принципа единственной ответственности."
---
