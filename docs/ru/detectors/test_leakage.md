---
title: Утечка тестов
description: "Обнаруживает рабочий код, который импортирует из тестовых файлов, что может привести к увеличению размера бандла, рискам безопасности и поломке сборок."
---
