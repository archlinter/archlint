---
title: Операция «Дробовик»
description: "Обнаруживает файлы, которые часто меняются вместе, что указывает на то, что одно изменение требований вынуждает вносить множество мелких изменений в несколько модулей."
---
