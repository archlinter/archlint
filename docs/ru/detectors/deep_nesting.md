...
description: "Определяет блоки кода, вложенные слишком глубоко, что экспоненциально усложняет чтение кода и указывает на функции, которые делают слишком много."
---
