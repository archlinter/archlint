...
description: "Интегрируйте archlint в ваш рабочий процесс GitHub, чтобы предотвращать архитектурные регрессии в Pull Requests с автоматическими комментариями и аннотациями."
---
