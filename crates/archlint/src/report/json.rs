        ...
        .map(|(smell, explanation)| {
            let mut smell_json = json!({
                "type": match &smell.smell_type {
                    ...
                    SmellType::HighCyclomaticComplexity { name, line, complexity } => format!("high_cyclomatic_complexity: {} at line {} (complexity: {})", name, line, complexity),
                    SmellType::HighCognitiveComplexity { name, line, complexity } => format!("high_cognitive_complexity: {} at line {} (complexity: {})", name, line, complexity),
